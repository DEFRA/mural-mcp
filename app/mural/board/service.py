...
from app.mural.board.renderers import msx as msx_renderer
from app.mural.board.summary import builder as summary_builder
from app.mural.board.summary import renderer as summary_renderer
from app.mural.board.widgets import builder, nodes
from app.mural.board.widgets.strategies import (
...
class BoardService:
    ...
    async def fetch_region(
        ...
        try:
            ...
            return f'Region "{region_id}" not found on board {mural_id}.'
