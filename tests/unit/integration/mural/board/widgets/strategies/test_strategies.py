...
class TestParentIdStrategy:
    def test_flat_widgets(self) -> None:
    ...
    def test_table_expansion_into_row_nodes(self) -> None:
    ...
    def test_table_cell_placement_under_correct_column_node(self) -> None:
        table = widgets.TableWidget(
            id="table-1",
            type="table",
            x=0,
...
class TestSpatialGroupingStrategy:
    def test_single_widget_at_root(self) -> None:
    ...
    def test_isolated_widgets_each_at_root(self) -> None:
    ...
    def test_large_anchor_becomes_parent(self) -> None:
        ...
        result = spatial.SpatialGroupingStrategy(
            cluster_gap=100, anchor_ratio=3.0
        ).group([screen, slug])
    ...
    def test_no_clear_anchor_creates_group_node(self) -> None:
    ...
    def test_slug_lands_above_the_correct_screen(self) -> None:
        ...
        # positions are chosen so each is closest (by bbox distance) to its
        # own screen.
        ...
        result = spatial.SpatialGroupingStrategy(
            cluster_gap=100, anchor_ratio=3.0
        ).group([screen_a, slug_a, screen_b, slug_b])
    ...
    def test_tables_only_expanded_when_present(self) -> None:
        w = make_shape("w1", 0, 0, 100, 100)
        result = spatial.SpatialGroupingStrategy().group([w])
